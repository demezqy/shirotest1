...
public class AuthorizationTest {
    ...
    public void testAuthorization() {
        ...
        // 使用check方法进行授权，如果授权不通过会抛出异常
        //会抛出这个异常org.apache.shiro.authz.UnauthorizedException: Subject does not have permission [items:create:1]
        //对照shiro-permission.ini;文件没有这个"items:create:1"权限而是"user:create:1"
